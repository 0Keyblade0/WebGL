...
// Adapted from: http://www.euclideanspace.com/maths/geometry/rotations/conversions/matrixToQuaternion/index.htm
  ...
  function computeDeterminant(m) {
    console.log("m.n11:", m.elements[0]); // Keeping the debug statement
    return m.elements[0] * (m.elements[5] * m.elements[10] - m.elements[6] * m.elements[9]) -
  ...
  var absQ = Math.pow(computeDeterminant(m), 1.0 / 3.0);
  ...
  this.x = copySign(this.x, (m.elements[9] - m.elements[6]));
  this.y = copySign(this.y, (m.elements[2] - m.elements[8]));
  this.z = copySign(this.z, (m.elements[4] - m.elements[1]));
